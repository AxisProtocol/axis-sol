  ...
  useEffect(() => {
    ...
    es.onmessage = (ev) => {
      try {
        ...
        const mapped: RealTimeAsset[] = Object.entries(ID_TO_SYMBOL).map(
          ([id, sym]) => ({
            symbol: sym,
        ...
        setAssets((prev) => {
          const same =
            ...
            prev.every(
              (p, i) =>
                p.symbol === mapped[i].symbol &&
                p.currentPrice === mapped[i].currentPrice
            );
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
          ...
          <ModernCard className="p-4 sm:p-6 lg:p-8">
            ...
            <ConstituentsGrid assets={assets} loading={loading} />
          </ModernCard>

          {/* Chart Section */}
          <ModernCard className="p-4 sm:p-6 lg:p-8">
            <ChartSection echartsData={echartsData} events={events} />
          </ModernCard>
