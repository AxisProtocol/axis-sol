  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      const { transaction, memoId: mid } =
        await sdk.buildUsdcDepositTransaction(usdcAmount);
      setMemoId(mid);
  ...
  return (
    <>
      <ModalLayout isOpen={isOpen} onClose={onClose} titleId="buy-title">
        ...
        <div className="grid grid-cols-[1.2fr_0.8fr] gap-4 lg:grid-cols-1">
          ...
          <InfoDisplay
            ...
            items={[
              {
                label: 'Receiving Token (AXIS)',
                value: AXIS_MINT_2022.toBase58(),
              },
              {
                label: 'Treasury USDC ATA',
                value: TREASURY_USDC_ATA.toBase58(),
              },
      ...
      <SettlementModal
        ...
        memoId={memoId}
        expectedText={
          expectedAxis ? `~ ${expectedAxis.toFixed(6)} AXIS` : undefined
        }
