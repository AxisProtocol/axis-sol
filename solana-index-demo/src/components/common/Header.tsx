            ...
            >
              ...
              <div className="mt-auto flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <a href="https://x.com/Axis__Solana" target="_blank" rel="noreferrer" aria-label="Open X" className="p-2 rounded-md hover:bg-white/10">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden>
                      <path d="M3 3l7.5 9.5L3.8 21H6.9l5-6.3L16.8 21H21l-7.9-10.1L20.7 3h-3.1l-4.5 5.6L9 3H3z" fill="white"/>
                    </svg>
                  </a>
                  <a href="https://discord.gg/PTGVdd5KZQ" target="_blank" rel="noreferrer" aria-label="Open Discord" className="p-2 rounded-md hover:bg-white/10">
